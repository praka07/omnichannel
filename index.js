...
app.post('/ominichannel/sendMessenger', function (req, res) {
  ...
  var temp = { "attachment": { "type": "template", "payload": { "template_type": "button", "text": "Hi, Buddy Great to see you here... Please proceed seat selection by clicking the folloeing button", "buttons": [{ "type": "web_url", "url": "https://www.messenger.com", "title": "Continue Journey" }] } } }
